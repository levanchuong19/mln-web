    ...
    <section id="cauhoi" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="bg-[var(--color-surface)]/50 border border-[var(--color-border)] rounded-xl p-8 max-w-3xl mx-auto">
            <p className="text-xl md:text-2xl text-[var(--color-text)] font-semibold italic text-balance">
        ...
        >
          ...
          <motion.div
            ...
            className="bg-[var(--color-surface)]/50 border border-[var(--color-border)] rounded-lg p-8 hover:border-[var(--color-accent)] transition-all duration-300"
            whileHover={{ y: -5 }}
          >
            <h3 className="text-2xl font-bold text-[var(--color-accent)] mb-6">Tất Yếu của Lịch Sử</h3>
          ...
          <motion.div
            variants={itemVariants}
            className="bg-[var(--color-surface)]/50 border border-[var(--color-border)] rounded-lg p-8 hover:border-[var(--color-accent-light)] transition-all duration-300"
            whileHover={{ y: -5 }}
          >
            <h3 className="text-2xl font-bold text-[var(--color-accent-light)] mb-6">Chiến Lược Thích Ứng</h3>
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-[var(--color-text)] mb-2 flex items-center gap-2">
                  <CheckCircle2 size={20} className="text-[var(--color-accent-light)]" />
                  Chủ Nghĩa Thực Dụng
                </h4>
                <p className="text-[var(--color-text-muted)] text-sm">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-[var(--color-accent)]/10 to-[var(--color-accent-light)]/10 border border-[var(--color-accent)]/30 rounded-lg p-8"
        >
          <h3 className="text-2xl font-bold text-[var(--color-accent)] mb-4">Kết Luận Chính</h3>
          <p className="text-lg text-[var(--color-text)] leading-relaxed text-balance">
